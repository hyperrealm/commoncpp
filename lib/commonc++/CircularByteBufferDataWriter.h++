...
#ifndef __ccxx_CircularByteBufferDataWriter_hxx
#define __ccxx_CircularByteBufferDataWriter_hxx
 ...
 * @author Mark Lindner
 */
class COMMONCPP_API CircularByteBufferDataWriter : public DataWriter
{
 public:

  /**
   * Construct a new CircularByteBufferDataWriter for the given
   * CircularByteBuffer.
   *
 ...
 private:
  ...
  CCXX_COPY_DECLS(CircularByteBufferDataWriter);
};
