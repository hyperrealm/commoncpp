...
#include "ByteArrayDataReaderTest.h++"
#include "TestUtils.h++"
...
CPPUNIT_TEST_SUITE_REGISTRATION(ByteArrayDataReaderTest);

/*
 */

CppUnit::Test *ByteArrayDataReaderTest::suite()
{
  CCXX_TESTSUITE_BEGIN(ByteArrayDataReaderTest);
  CCXX_TESTSUITE_TEST(ByteArrayDataReaderTest, testByteArrayDataReader);
  CCXX_TESTSUITE_END();
}
...
void ByteArrayDataReaderTest::setUp()
{
}
...
void ByteArrayDataReaderTest::tearDown()
{
}
...
void ByteArrayDataReaderTest::testByteArrayDataReader()
{
  // TODO
  ...
  ByteArrayDataReader writer(buf, sizeof(buf));
  ...
  try
  {
    ...
    writer << DataReader::SetLength(8) << "AAAA" << DataReader::SetLength(0)
           << "BLAH" << byte_t(0x11);
